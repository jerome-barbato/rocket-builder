    ...
    var Slider = function (config) {
        ...
        self.__construct = function (config) {
            ...
            if (self.config.display) {
                try {
                    self.config.display = JSON.parse('{"' + self.config.display.replace(/:/g, '":"')
                                                                .replace(/,/g, '","') + '"}')
                } catch (e) {}
            }
        ...
        self._show = function (index, animate, callback) {
            ...
            self.config.$element.trigger('slider.updated', [
                index,
                self.context.indices.current
            ]);
    ...
    var Sliders = function () {
        ...
        self.add = function ($slider) {
            ...
            if ($(this).data('context')) {
                try {
                    context = $slider.data('context') ? JSON.parse('{' + $slider.data('context')
                                                                                .replace(/'/g, '"') + '}') : {};
                } catch (e) {}
            }
            else {
